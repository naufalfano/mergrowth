...
from app.routers import health, auth, product, demand_forecasting, dashboard, marketing, market_entry, user_shop, corpus, brand_advisor, restock_recommendation, price_analysis
...
app.include_router(restock_recommendation.router, prefix="/api/v1")
